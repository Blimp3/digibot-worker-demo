/* eslint-disable */
// Sanitized Worker type snapshot for the provider-free public demo.
...
interface __BaseEnv_Env {
	...
	INTEGRATION_ALLOWED_ORIGINS: "chrome-extension://aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa";
	ALLOWED_SOURCE_HOSTS: "youtube.com,www.youtube.com,m.youtube.com,music.youtube.com,youtu.be,instagram.com,www.instagram.com,tiktok.com,www.tiktok.com,vm.tiktok.com,vt.tiktok.com,x.com,www.x.com,twitter.com,www.twitter.com,vimeo.com,www.vimeo.com,player.vimeo.com,reddit.com,www.reddit.com,old.reddit.com,np.reddit.com,nm.reddit.com,redditmedia.com,www.redditmedia.com,pinterest.com,www.pinterest.com,pinterest.ca,www.pinterest.ca,co.pinterest.com,www.ted.com,embed.ted.com,embed-ssl.ted.com";
	DEFAULT_MAX_HEIGHT: "1080";
	MAX_REQUEST_BODY_BYTES: "16384";
	MAX_MEDIA_DURATION_SECONDS: "7200";
	MAX_SOURCE_BYTES: "524288000";
	MAX_TEMP_DISK_BYTES: "1000000000";
	...
	R2_LINK_TTL_SECONDS: "3600";
	R2_RETENTION_SECONDS: "86400";
	PUBLIC_WORKER_BASE_URL: "https://worker.example.invalid";
	TELEGRAM_BOT_API_BASE: "https://api.telegram.org";
	R2_BUCKET_NAME: "demo-media";
	R2_ENDPOINT: "https://account-id.r2.cloudflarestorage.com";
	DOWNLOADER_CONTAINER: DurableObjectNamespace<import("./src/index").DownloaderContainer>;
	TRANSCRIPTION_CONTAINER: DurableObjectNamespace<import("./src/index").TranscriptionContainer>;
	PROVENANCE_VERIFIER: Service /* synthetic verifier binding */;
	MEDIA_WORKFLOW: Workflow<Parameters<import("./src/index").MediaJobWorkflow['run']>[0]['payload']>;
	INTEGRATION_WORKFLOW: Workflow<Parameters<import("./src/index").IntegrationWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "DownloaderContainer" | "NewsScheduler" | "TranscriptionContainer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "INTEGRATION_ENABLED" | "INTEGRATION_ALLOWED_ORIGINS" | "ALLOWED_SOURCE_HOSTS" | "DEFAULT_MAX_HEIGHT" | "MAX_REQUEST_BODY_BYTES" | "MAX_MEDIA_DURATION_SECONDS" | "MAX_SOURCE_BYTES" | "MAX_TEMP_DISK_BYTES" | "MAX_TELEGRAM_BYTES" | "MAX_URL_LENGTH" | "DOWNLOAD_TIMEOUT_SECONDS" | "PROBE_TIMEOUT_SECONDS" | "FFMPEG_TIMEOUT_SECONDS" | "TELEGRAM_UPLOAD_TIMEOUT_SECONDS" | "PROCESS_TERM_GRACE_SECONDS" | "MAX_RETRIES" | "STRICT_DEPENDENCIES" | "MAX_JOBS_PER_HOUR" | "MAX_ACTIVE_JOBS" | "MAX_ACTIVE_TRANSCRIPTIONS" | "JOB_TIMEOUT_SECONDS" | "MAX_TRANSCRIPT_DURATION_SECONDS" | "TRANSCRIPTION_TIMEOUT_SECONDS" | "R2_LINK_TTL_SECONDS" | "R2_RETENTION_SECONDS" | "PUBLIC_WORKER_BASE_URL" | "TELEGRAM_BOT_API_BASE" | "R2_BUCKET_NAME" | "R2_ENDPOINT">> {}
}
